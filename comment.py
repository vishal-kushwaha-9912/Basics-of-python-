...
# MULTI-LINE COMMENT : it is a comment that is written in multiple lines. It is defined by using triple quotes """ or '''.

""" this is a multi-line comment
it can be used to explain the code in more detail and it can also be used to write a docstring for a function or a class. """